...
export default class SidebarLogo extends React.Component {
    constructor(props) {
        super(props);
        this.logoMax = 8;
        this.state = { logoEffect: Math.floor(Math.random() * this.logoMax) + 1 };
    }

    mouseLeave = () => {
        this.setState({ logoEffect: Math.floor(Math.random() * this.logoMax) + 1 });
    }
                    ...
                    <div className="marginBottom-s">
                        <IndexLink to="/">
                            <svg
                                ...
                                <pattern id="effect" width="1" height="1" viewBox="0 0 80 30" preserveAspectRatio="none"><image id="effect-image" xmlnsXlink="http://www.w3.org/1999/xlink" xlinkHref={`/assets/marvel-styleguide/images/logo-effects/logo-${this.state.logoEffect}.gif`} width="80" height="30" preserveAspectRatio="none"></image></pattern>
