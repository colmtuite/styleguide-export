                    ...
                    <div className="marginBottom-s">
                        <IndexLink to="/">
                            <svg
                                ...
                                <pattern id="effect" width="1" height="1" viewBox="0 0 80 30" preserveAspectRatio="none"><image id="effect-image" xmlnsXlink="http://www.w3.org/1999/xlink" xlinkHref={`/assets/marvel-styleguide/images/logo-${this.state.logoEffect}.gif`} width="80" height="30" preserveAspectRatio="none"></image></pattern>
