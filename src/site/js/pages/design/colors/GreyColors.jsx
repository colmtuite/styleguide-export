...
import ColorRow from '~/pages/design/colors/ColorRow';
            ...
            <div className="grid grid--m grid--2 breakPointM-grid--3 breakPointL-grid--4">
                <div>
                    <div className="position-relative bg-black borderRadius-m overflow-hidden">
                        <ColorRow color="black" title="black" textColor="white" />
                    </div>
                </div>

                <div>
                    <div className="position-relative bg-black borderRadius-m overflow-hidden">
                        <ColorRow color="steel" title="steel" textColor="white" />
                    </div>
                </div>

                <div>
                    <div className="position-relative bg-black borderRadius-m overflow-hidden">
                        <ColorRow color="slate" title="slate" textColor="white" />
                    </div>
                </div>

                <div>
                    <div className="position-relative bg-black borderRadius-m overflow-hidden">
                        <ColorRow color="silver" title="silver" textColor="white" />
                    </div>
                </div>

                <ColorBlock color="smoke" textColor="slate" lightColor="1" />

                <ColorBlock color="snow" textColor="slate" lightColor="1" border={ border } />
            </div>
        </section>
    );
}
