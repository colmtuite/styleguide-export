            ...
            <div className="grid grid--m grid--2 breakPointM-grid--3 breakPointL-grid--4">
                <div>
                    <div className="position-relative bg-black borderRadius-m overflow-hidden">
                        <ColorRow color="blue" title="blue" textColor="white" />
                    </div>
                </div>

                <div>
                    <div className="position-relative bg-black borderRadius-m overflow-hidden">
                        <ColorRow color="positive" title="Positive" textColor="white" />
                    </div>
                </div>

                <div>
                    <div className="position-relative bg-black borderRadius-m overflow-hidden">
                        <ColorRow color="negative" title="negative" textColor="white" />
                    </div>
                </div>
            </div>
        </section>
