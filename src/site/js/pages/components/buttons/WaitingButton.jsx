            ...
            <SectionExample>
                <div className="padding-m">
                    <div className="uiIcon uiIcon--m is-loading">
                        <button className="button button--m button--flat bg-marvel is-disabled" type="button" disabled>Loading...</button>

                        <svg className="svgIcon fill-silver" width="24" height="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" enable-background="new 0 0 24 24">
