            ...
            <SectionExample>
                <div className="padding-m inline">
                    <div className="marginRight-m">
                        <a className="button button--m button--ghost bg-marvel--hover" href="#" role="button">Default</a>
                    </div>

                    <div className="marginRight-m">
                        <a className="button button--m button--ghost bg-orange--hover" href="#" role="button">Orange</a>
                    </div>

                    <div>
                        <a className="button button--m button--ghost bg-negative--hover" href="#" role="button">Negative</a>
                    </div>
                </div>
            </SectionExample>
