        ...
        <section className="marginBottom-xl">
            ...
            <SectionExample>
                <div className="padding-m">
                    <a className="uiIcon uiIcon--m button button--m button--ghost bg-marvel--hover" href="#" role="button">
                        <svg className="svgIcon fill-positive" width="24" height="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" enable-background="new 0 0 24 24">
