                ...
                <div className="padding-m textAlign-center breakPointM-textAlign-left">
                    <div className="inline">
                        <div className="marginRight-m">
                            <a
                                className="link link--light link--underline fontSize-m lineHeight-l display-inlineBlock"
                                href="#">
                        ...
                        <div className="marginRight-m">
                            <a
                                className="link link--dark link--underline fontSize-m lineHeight-l display-inlineBlock"
                                href="#">
