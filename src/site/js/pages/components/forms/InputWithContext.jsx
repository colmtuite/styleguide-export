                ...
                <div className="padding-m">
                    <div className="marginBottom-m">
                        <div className="inputGroup inputGroup--m">
                            ...
                            <div>
                                <input className="input input--m input--default" type="text" placeholder="Enter something" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="inputGroup inputGroup--m">
                        ...
                        <div>
                            <input className="input input--m input--default borderRadius-0" type="text" placeholder="Enter something" />
                        </div>
