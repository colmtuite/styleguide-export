        ...
        <section className="marginBottom-xl">
            ...
            <SectionExample>
                <div className="padding-m">
                    <div className="uiIcon uiIcon--m uiIcon--textarea" style={{ width: '300px' }}>
                        <textarea className="textarea textarea--m textarea--default" placeholder="Write a comment..."></textarea>

                        <svg className="svgIcon fill-smoke--d" width="24" height="24" xmlns="http://www.w3.org/2000/svg" viewBox="3 -3 24 24" enable-background="new 3 -3 24 24">
